 ...
 *
 * $Id: PlayerClient.java 87 2010-04-21 21:58:41Z corot $
 *
 */
...
import net.stallbaum.jarvisagent.javaclient3.structures.player.PlayerDeviceDriverInfo;
import net.stallbaum.jarvisagent.javaclient3.structures.player.PlayerDeviceDevlist;
import net.stallbaum.jarvisagent.javaclient3.structures.PlayerDevAddr;
...
import net.stallbaum.jarvisagent.javaclient3.xdr.*;
...
//    private long    timeout = 100;
    ...
    public PlayerClient (String serverName, int portNumber) {
        try {
            ...
            java.util.logging.FileHandler fh = new java.util.logging.FileHandler("c:\\TestLog.log", false);
...
//        } catch (IOException e) { throw new PlayerException (e); }
    ...
    /**
     * Return the net.stallbaum.jarvisagent.javaclient3 logger.
     * @return the net.stallbaum.jarvisagent.javaclient3 logger as a Logger object
     */
