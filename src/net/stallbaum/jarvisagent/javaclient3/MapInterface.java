...
import net.stallbaum.jarvisagent.javaclient3.structures.PlayerSegment;
import net.stallbaum.jarvisagent.javaclient3.structures.PlayerPose;
import net.stallbaum.jarvisagent.javaclient3.structures.map.PlayerMapInfo;
import net.stallbaum.jarvisagent.javaclient3.structures.map.PlayerMapData;
import net.stallbaum.jarvisagent.javaclient3.structures.map.PlayerMapDataVector;
